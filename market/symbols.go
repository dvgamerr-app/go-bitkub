...
// Symbol represents a trading symbol information
type Symbol struct {
...
// SymbolsResponse represents the response from /api/v3/market/symbols endpoint
type SymbolsResponse struct {
	Error  int      `json:"error"`
	Result []Symbol `json:"result"`
}

// GetSymbols lists all available symbols
